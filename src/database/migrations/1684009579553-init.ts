...
export class Init1684009579553 implements MigrationInterface {
    name = 'Init1684009579553'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "studyschedule" ("id" character varying NOT NULL, "completecourse" boolean NOT NULL, "courseorder" bigint NOT NULL, "userId" character varying, "courseId" character varying, CONSTRAINT "PK_231eb05d982f98ac42c6f7043c9" PRIMARY KEY ("id"))`);
